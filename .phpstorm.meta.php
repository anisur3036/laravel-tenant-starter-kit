...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Anis\Code\multi_tenancy_with_multi_db\public\storage' => 'string',
            'filesystems.links.C:\Users\Anis\Code\multi_tenancy_with_multi_db\public\products-images' => 'string',
...
'app.aliases.Vite','app.domain','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Anis\\Code\\multi_tenancy_with_multi_db\\public\\storage',
'filesystems.links.C:\\Users\\Anis\\Code\\multi_tenancy_with_multi_db\\public\\products-images','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'tenancy.seeder_parameters.--class','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key','broadcasting.connections.reverb.secret',
...
'sanctum.csrf-cookie','stancl.tenancy.asset','dashboard','profile.edit',
'profile.update','profile.destroy','tenants.index','tenants.create','tenants.store',
'tenants.show','tenants.edit','tenants.update','tenants.destroy','permissions.index',
...
'roles.edit','roles.update','roles.destroy','users.index','users.create',
'users.store','users.edit','users.update','users.destroy','categories.index',
'categories.create','categories.store','categories.show','categories.edit','categories.update',
'categories.destroy','products.index','products.create','products.store','products.show',
'products.edit','products.update','products.destroy','register','login','password.request','password.email',
...
'dashboard','profile.edit','profile.update','profile.destroy','tenants.index',
'tenants.create','tenants.store','tenants.show','tenants.edit','tenants.update',
'tenants.destroy','permissions.index','permissions.create','permissions.store','permissions.show',
'permissions.edit','permissions.update','permissions.destroy','roles.index','roles.create',
'roles.store','roles.show','roles.edit','roles.update','roles.destroy',
'users.index','users.create','users.store','users.edit','users.update',
'users.destroy','categories.index','categories.create','categories.store','categories.show',
'categories.edit','categories.update','categories.destroy','products.index','products.create',
'products.store','products.show','products.edit','products.update','products.destroy','register','login',
...
'logout','dashboard','profile.edit','profile.update',
'profile.destroy','users.index','users.create','users.store','users.show',
'users.edit','users.update','users.destroy','register',
...
'APP_URL','APP_DOMAIN','APP_PORT','APP_LOCALE','APP_FALLBACK_LOCALE',
